...
def _build_mcq_prompt(topic: str, count) -> str:
    ...
    return (
        ...
        f"🟥 QUESTION QUALITY:\n"
        f"- Short and clear (roughly 1-2 lines), never needlessly wordy or convoluted.\n"
        ...
        f"- Don't make junk/filler MCQs just to hit a number — if you must reuse "
        ...
        f"student actually has to know the material rather than guess by elimination.\n"
        f"- Mixing information from different parts of the source into distractors "
        f"is fine and encouraged, as long as it stays factually accurate to the source.\n"
