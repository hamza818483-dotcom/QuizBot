...
def _build_topic_verify_prompt(mcqs: list) -> str:
    ...
    return (
        ...
        "6) LOGICAL CHECK: does the marked answer actually make sense for that question, or does "
        "any option/explanation contradict it (misread word that looks valid but is wrong — wrong "
        "city/date/number/name)? Only flag if the page text itself proves it. Add to the SAME "
        "word_fixes array as {\"qsn_no\": N, \"field\": \"question\"/\"optionA-D\"/\"answer\", "
        "\"correct_text\": \"...\"}.\n\n"
