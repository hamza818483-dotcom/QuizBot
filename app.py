...
def _build_unmesh_heading_scan_prompt() -> str:
    ...
    return (
        ...
        "not a single fact. A HOLLOW/OUTLINE STAR (✪) appearing 1, 2, or 3 times immediately before a "
        "bold-black heading on white/light background is a STRONG standalone topic marker by itself — "
        "even a single ✪ before such a heading counts, treat it as a genuine topic heading.\n\n"
