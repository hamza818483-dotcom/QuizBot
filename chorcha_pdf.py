...
.hdr h1 { font-size: 19px; font-weight: 800; letter-spacing: 0.3px; color: #166534; }
.hdr .sub { font-size: 12px; color: #15803d; margin-top: 5px; }
.hdr .brand { font-size: 10px; color: #4d7c0f; margin-top: 3px; }
...
.q-no { font-weight: 800; color: #15803d; flex-shrink: 0; }
.q-text { color: #000; font-weight: 600; line-height: 1.6; flex: 1; }
.tag-chip {
...
.a-row {
  ...
  background: rgba(22,163,74,0.1); padding: 10px 12px;
}
.a-label { font-weight: 800; color: #166534; flex-shrink: 0; }
.a-text { color: #000; line-height: 1.7; flex: 1; }
...
.stem-row {
  display: flex; align-items: flex-start; gap: 8px;
  background: #dcfce7; padding: 9px 12px; border-radius: 7px; margin-bottom: 8px;
}
.stem-text { color: #000; font-weight: 700; line-height: 1.65; flex: 1; }
.sub-box {
...
.sub-box .q-row { background: #F0FDF4; }
.sub-label { font-weight: 800; color: #15803d; flex-shrink: 0; min-width: 18px; }

.q-img-wrap { margin-top: 6px; }
.q-img {
  max-width: 100%; max-height: 320px; display: block;
  margin: 6px auto 0; border-radius: 6px; border: 1px solid #86efac;
}

.footer {
  text-align: center; font-size: 9.5px; color: #4d7c0f;
  margin-top: 14px; padding-top: 10px; border-top: 1px solid #bbf7d0;
}
"""
