...
from quiz_system import (
    quiz_create_handler, quiz_start_handler, quiz_answer_handler,
    tagQ_handler, expQ_handler, qlist_handler, qdel_handler,
...
def main():
    ...
    app.add_handler(CommandHandler("q", quiz_create_handler))
    app.add_handler(CommandHandler("tagQ", tagQ_handler))
    app.add_handler(CommandHandler("expQ", expQ_handler))
    app.add_handler(CommandHandler("qlist", qlist_handler))
    app.add_handler(CommandHandler("qdel", qdel_handler))
