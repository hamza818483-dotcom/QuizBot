# Deployment System — HF Space Sync (v4.6)

## Current setup

- **Primary bot host**: `HF04/quizbot-backup` (Hugging Face Space, Docker SDK)
...
| `HF_TOKEN_PRIMARY` | Write-access token for `HF04` account, pushes to primary space |
