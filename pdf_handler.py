...
📊 COUNT: MANDATORY minimum ১৫টি MCQ — page-এ তথ্য বেশি থাকলে ৩৫ পর্যন্ত যেতে পারো। ১৫-এর নিচে কোনো অবস্থাতেই থামা যাবে না যদি page-এ MCQ বানানোর মতো তথ্য অবশিষ্ট থাকে — প্রতিটা লাইন/প্যারাগ্রাফ/বক্স/সারণি থেকে একাধিক প্রশ্ন বানিয়ে (আলাদা angle থেকে জিজ্ঞেস করে — direct fact, reverse, cause-effect, comparison) হলেও ১৫ পূরণ করো। শুধুমাত্র page সত্যিই blank/cover-page হলে (কার্যত কোনো তথ্য নেই) কম MCQ গ্রহণযোগ্য।
